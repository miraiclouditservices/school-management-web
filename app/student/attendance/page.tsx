  ...
  return (
    <DashboardShell role="student">
      ...
      {loading ? (
        ...
        <>
          <div className="row g-4 mb-4">
            ...
            <div className="col-md-3">
              <div className="card border-0 shadow-sm rounded-4 p-4 bg-white border-start border-5 border-warning h-100">
                <h6 className="text-warning extra-small fw-900 uppercase tracking-wider mb-2">Late Arrivals</h6>
                <h2 className="fw-900 text-dark mb-0">{stats.late}</h2>
              </div>
            </div>
            <div className="col-md-3">
                  ...
                  <div className="card-body p-4">
                    ...
                    <div className="d-flex gap-4 justify-content-center mt-4">
                      <div className="d-flex align-items-center gap-2 extra-small fw-bold text-muted">
                        <div className="status-dot bg-success"></div> Present
                      </div>
                      <div className="d-flex align-items-center gap-2 extra-small fw-bold text-muted">
                        <div className="status-dot bg-danger"></div> Absent
                      </div>
                      <div className="d-flex align-items-center gap-2 extra-small fw-bold text-muted">
                        <div className="status-dot bg-warning"></div> Late
                      </div>
                      <div className="d-flex align-items-center gap-2 extra-small fw-bold text-muted">
                        <div className="status-dot bg-info"></div> Leave
                      </div>
                    </div>
                  </div>
               </div>
      ...
      <style jsx>{`
        ...
        .premium-stats-pill { min-width: 200px; }
        ...
        .status-dot-mini { position: absolute; bottom: 6px; width: 4px; height: 4px; border-radius: 50%; background: rgba(255,255,255,0.5); }
